      ...
      <div className="flex flex-col h-screen bg-background overflow-hidden">
        ...
        <div className="flex flex-1 min-h-0">
          ...
          <div className="flex-1 flex flex-col min-w-0">
            <header className="flex items-center justify-between px-3 sm:px-6 py-3 border-b border-border bg-card">
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <h1 className="text-xs sm:text-sm font-semibold text-foreground truncate">{hospitalTitles[hospitalTab] || "Dashboard"}</h1>
                </div>
                <p className="text-[10px] sm:text-[11px] text-muted-foreground hidden sm:block">Digital Health Mission · Hospital Administration</p>
              </div>
            ...
            <main id="main-content" className="flex-1 overflow-y-auto p-3 sm:p-6" role="main" aria-label="Hospital dashboard content">
